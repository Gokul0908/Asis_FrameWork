...
describe("Creating a full flow for FEMS", async () => {
    ...
    describe("Asis User Login to the Application and Creating User Area Master and User Location Master", async () => {
        ...
        it("Creating Testing and Commissioning in FEMS", async () => {
            ...
            await testingAndCommissioning.EnterRequestorName(constant.requestorName2)
            await testingAndCommissioning.selectAssetClassification(constant.assetClassification)
            await testingAndCommissioning.selectAssetGroupCode(constant.assetGroupCode)
