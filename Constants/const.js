...
export const aInvalidPassword = "Welcome@1234"
export const gmServices = "GM"
export const fmsServices = "FMS"
export const SRservice ="SR"
...
export const linenCode = "AI" + utils.getRandomString(4)
export const linenDescription = "AItem" + utils.getRandomString(4)
...
export const requestType = "BER "     //  "BER "  // "T&C "
export const requestorName = "Marissa Yusop"
export const requestorDesignation = "Liaison Officer"
